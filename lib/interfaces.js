...
class Interfaces {
  ...
  */
  get length () {
    return this[adapterKey].length(new Element('', this.adapter))
  }
  ...
  */
  at (nth) {
    ...
    var adapter = this.adapter.contextulise(new Element('', this.adapter, nth))
    return new SubInterface(adapter, nth)
  }
